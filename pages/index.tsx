      ...
      <main className="h-screen flex flex-col items-center justify-center relative flex-col">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl p-4 pr-4 bg-white shadow-md sm:w-8/12 md:w-10/12 w-7/12 md:h-4/5">
          <div className="flex flex-col justify-center">
            <h1 className="text-xl font-bold mb-4 font-mons">AI Content Detector</h1>
            <p className="mb-2 font-mons">Please input your text and press the button to receive a percentage indicating the likelihood that your text was generated by AI.</p>
            <textarea
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="relative w-10/12 ">
        ...
        <div className="progress-bar bg-gray-200 h-12 rounded-lg relative overflow-hidden">
          <div className={`progress-bar-fill bg-blue-500 h-full absolute left-0 top-0`} style={{ width: `${progress}%` }}></div>
        </div>
      </div>
      <div className={`text-sm mt-4 font-mons ${textColor} ${progress === -1 ? "hidden" : "block"}`}>
        {progress === 10 ? "" : isFake ? "Your text is likely AI generated" : "Your text is likely human written"}
      </div>
    </div>
  </div>
</div>
